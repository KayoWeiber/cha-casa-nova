...
export const DEFAULT_GROOM_WIGGLE_CONFIG = {
  ...
  face: { src: rostoNoivo, x: -5, y: 0, scale: 1.2, rotate: -9, zIndex: 2 },
  // Gravata (camada de trás) mais abaixo por padrão
  veil: { src: gravataNoivo, x: 1, y: 98, scale: 0.83, rotate: -9, zIndex: 2 },
  motion: { enabled: true, durationMs: 2900, amplitudeX: 6, amplitudeY: 5, rotateDeg: 2, phaseMs: 0 },
