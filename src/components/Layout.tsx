  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        ...
        <Leaf
          className="absolute left-6 top-1/2 -translate-y-1/2 rotate-90 opacity-25 blur-[0.5px]"
          width={140}
          height={120}
        />
        <Leaf
          className="absolute right-6 top-1/2 -translate-y-1/2 -rotate-90 opacity-25 blur-[0.5px]"
          width={140}
          height={120}
        />
      </div>
      ...
      <main
        className={
          isAdmin
            ? 'relative w-full max-w-none px-0 mx-0'
            : 'app-container relative mx-auto'
        }
      >
        {children}
      </main>
